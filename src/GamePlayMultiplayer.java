...
public class GamePlayMultiplayer extends JPanel implements KeyListener{
    ...
    private int brickposX2[]={440,540,640,740,840,440,540,640,740,840};
    ...
    public void paint(Graphics g){
        ...
        if(score==1000){
            play=false;
            if(state==0){
                score1=score-(gametimer/50);
                reset();
                state=1;
            }else if(state==1){
                score2=score-(gametimer/50);
                if(score1>score2){
                    g2d.setFont(new Font("Papyrus", 1, 45));
                    g2d.drawString("Player 1 won!!!", 450, 250);
                    g2d.setFont(new Font("Papyrus", 1, 25));
                    g2d.drawString("Player 1 Score: "+score1, 10, 340);
                    g2d.drawString("Player 2 Score: "+score2, 10, 380);
                }else{
                    g2d.setFont(new Font("Papyrus", 1, 45));
                    g2d.drawString("Player 2 won!!!", 450, 250);
                    g2d.setFont(new Font("Papyrus", 1, 25));
                    g2d.drawString("Player 1 Score: "+score1, 10, 340);
                    g2d.drawString("Player 2 Score: "+score2, 10, 380);
                }
            ...
            g2d.drawString("Score: "+(score-(gametimer/50)), 10, 380);
        }
